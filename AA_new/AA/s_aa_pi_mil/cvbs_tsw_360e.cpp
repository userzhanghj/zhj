...
void VideoCaptureCallbackInternal(const BYTE * pbyImage, int cbImageStride, UINT64 u64TimeStamp)
{
	...
	memcpy(s_aa::img_buf, pbyImage, IMG_WIDTH*IMG_HEIGHT*2);
//	log("get img");

//	YCbCrITUToBmp(1, s_aa::img_buf, s_aa::bmp_buf_t, IMG_WIDTH, IMG_HEIGHT);	
...
int CVBS_TSW_306E::cap(BYTE *buf, int buf_size)
{
//	log("T306E capture.");
	//memcpy(buf, s_aa::img_buf, IMG_WIDTH*IMG_HEIGHT*3);
	return TRUE;
}
