...
namespace ai_img
{
	...
	public:
		...
		void bmp24_to_y24(const BYTE *bmp_source, int bmp_w, int bmp_h, RECT *y_rect, BYTE *y_data);
	...
	public:
		...
		int display2(HWND hwnd, const BYTE *bmp_source, int img_w, int img_h, int display_width, int display_height, int img_ch=3, int start_x=0, int start_y=0, int is_full_sized=FALSE, int stretch_mode=HALFTONE, LPVOID temp=NULL);
	...
	AI_EXPORT_IMG float get_raw10_avg_g(BYTE *raw10, int img_w, int img_h, int data_order, RECT *roi);
	AI_EXPORT_IMG float get_raw8_avg_g(BYTE *raw8, int img_w, int img_h, int data_order, RECT *roi);

	AI_EXPORT_IMG float get_bmp_roi_avg_val(const BYTE *bmp_source, int bmp_w, int bmp_h, RECT *roi, int ch = B_CHANNEL);
	AI_EXPORT_IMG float get_bmp_y_roi_avg_val(const BYTE *bmp_y_soruce, int bmp_w, int bmp_h, RECT *roi);
	...
	AI_EXPORT_IMG BOOL  get_bmp_roi_avg_val(const BYTE *bmp_source, int bmp_w, int bmp_h, RECT *roi, float &avg_y, float &avg_cb, float &avg_cr);
